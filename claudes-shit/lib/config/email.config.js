...
export const EMAIL_CONFIG = {
    ...
    templates: {
        diagnosticReport: {
            subject: (vehicle) => `Your DiagnosticPro AI Report - ${vehicle}`,
        ...
        testEmail: {
            subject: (num, vehicle) => `[TEST ${num}] Diagnostic Report - ${vehicle}`,
...
export function validateEmailConfig() {
    ...
    if (!config) {
        return {
            valid: false,
            message: "No email service configured. Set GMAIL_APP_PASSWORD, SENDGRID_API_KEY, or SMTP_PASSWORD in environment variables.",
        };
    }
